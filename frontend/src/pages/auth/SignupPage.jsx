...
import { Twitter, Zap, Eye, EyeOff } from 'lucide-react'
...
const SignupPage = () => {
  ...
  const handleOAuthSignup = (provider) => {
    if (provider === 'google') {
      ...
      window.location.href = import.meta.env.VITE_LINKEDIN_AUTH_URL || 'http://localhost:5000/api/auth/linkedin'
    }
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Start your journey to better social media management</p>
        </div>
